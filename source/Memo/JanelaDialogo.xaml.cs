...
namespace Memo
{
    ...
    {
        private JanelaDialogo(string titulo, string mensagem, bool confirmacao, bool perigo)
        {
            InitializeComponent();
        ...
        /// <summary>Pergunta Sim/Não. Retorna true se confirmado.</summary>
        public static bool Confirmar(Window dono, string titulo, string mensagem, bool perigo = false)
        {
            var janela = new JanelaDialogo(titulo, mensagem, confirmacao: true, perigo);
        ...
        {
            var janela = new JanelaDialogo(titulo, mensagem, confirmacao: false, perigo: false);
            Posicionar(janela, dono);
            janela.ShowDialog();
        }
